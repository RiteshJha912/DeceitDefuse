  ...
  const features = [
    {
      ...
      description: 'Learn to identify and respond to emerging cyber threats in real-time.'
    },
    {
      icon: '🔒',
      title: 'Secure Practices',
      description: 'Master the latest security protocols and best practices for digital safety.'
    },
    {
      icon: '🔍',
      title: 'Risk Assessment',
      description: 'Evaluate and mitigate potential security risks in your digital environment.'
    },
    {
      icon: '🚨',
      title: 'Incident Response',
      description: 'Develop effective strategies for handling cybersecurity incidents.'
    }
  ]
    ...
    <div className="home-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          <div className="hero-left">
            <h1 className="hero-title">Deceit<br/>Defused</h1>
            <p className="hero-subtitle">
              Your comprehensive resource for advanced cybersecurity knowledge and digital safety protocols.
              Stay ahead of emerging threats with expert guidance and real-time updates.
            </p>
            <div className="hero-buttons">
              <Link to="/guide" className="cta-button primary">Access Security Protocols</Link>
              <Link to="/tools" className="cta-button secondary">Security Tools</Link>
            </div>
          </div>
      ...
      <section className="threat-feed">
        ...
        <div className="threat-grid">
          {latestThreats.map((threat, index) => (
            <div key={index} className={`threat-card ${threat.severity.toLowerCase()}`}>
      ...
      <section className="resources-section">
        ...
        <div className="resources-grid">
          <div className="resource-card">
            ...
            <Link to="/tools" className="resource-link">Explore Tools →</Link>
          </div>
          <div className="resource-card">
            ...
            <Link to="/guide" className="resource-link">Start Learning →</Link>
          </div>
          <div className="resource-card">
            <h3>Community</h3>
            <ul>
      ...
      <section className="cta-section">
        <div className="cta-content">
          ...
          <p>Join thousands of professionals and organizations already protecting their digital assets.</p>
