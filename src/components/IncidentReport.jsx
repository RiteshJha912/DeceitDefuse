...
import { FaUserShield, FaBuilding, FaGlobe, FaExclamationTriangle, FaPaperPlane, FaIdCard, FaPhoneAlt, FaEnvelope, FaMapMarkerAlt, FaUsers, FaBriefcase, FaLandmark, FaFileAlt, FaShieldAlt } from 'react-icons/fa';
        ...
        return (
            <div className="incident-report-container">
                <div className="success-message">
                    ...
                    <p>Thank you for reporting the incident. Our security team will review your submission and contact you shortly.</p>
                    <button className="submit-another-btn" onClick={() => setSubmitted(false)}>
