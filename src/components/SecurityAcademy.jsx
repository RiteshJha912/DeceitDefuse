  ...
  const sections = [
    {
      ...
      content: {
        overview: 'Cybersecurity is the practice of protecting systems, networks, and programs from digital attacks.',
        keyPoints: [
    ...
    },
    {
      ...
      content: {
        overview: 'Learn about the most common cyber threats and how to identify them.',
        keyPoints: [
          'Malware and viruses',
          'Phishing attacks',
          'Social engineering',
    ...
    },
    {
      ...
      content: {
        overview: 'Discover effective ways to protect yourself and your systems.',
        keyPoints: [
          'Password security',
    ...
    },
    {
      ...
      content: {
        overview: 'Follow these best practices to maintain strong cybersecurity.',
        keyPoints: [
  ...
  return (
    <div className="academy-container">
      <div className="academy-hero">
        ...
        <p>Your comprehensive guide to understanding and implementing cybersecurity</p>
      </div>
              ...
              <div className="interactive-elements">
                ...
                <div className="resources">
                  ...
                  <div className="resource-links">
                    <a href="#" className="resource-link">Detailed Guide</a>
                    <a href="#" className="resource-link">Video Tutorial</a>
                    <a href="#" className="resource-link">Infographic</a>
                  </div>
                </div>
              </div>
            </div>
