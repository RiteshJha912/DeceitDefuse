...
const News = () => {
  ...
  const API_URL = '/api/fetchNews' // Use the serverless function endpoint
  ...
  const filteredNews = news.filter((article) => {
    ...
    const matchesSource =
      selectedSource === 'all' ||
      article.source.name.toLowerCase().includes(selectedSource)
    ...
    const matchesCategory =
      ...
      (selectedCategory === 'threats' &&
        (article.title.toLowerCase().includes('threat') ||
  ...
  const getFallbackImage = (article) => {
    ...
    if (title.includes('ransomware'))
      return 'https://source.unsplash.com/400x200/?ransomware,cybersecurity'
    if (title.includes('phishing'))
      return 'https://source.unsplash.com/400x200/?phishing,security'
    if (title.includes('malware'))
      return 'https://source.unsplash.com/400x200/?malware,cybersecurity'
    if (title.includes('hack'))
      return 'https://source.unsplash.com/400x200/?hacking,cybersecurity'
  ...
  return (
    <div className='news-container'>
      <div className='news-hero'>
        ...
        <p>
          Stay informed with the most recent developments in cybersecurity and
          digital threats
        </p>
      </div>
